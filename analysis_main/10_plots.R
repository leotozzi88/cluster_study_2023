...
data=read.csv('data/dataset_merged_qc_imputed_combat_clin_std_clu_sympbeh_spl_treat.csv')
...
png(file=paste("plots/circuit_profile_bars_split1.png", sep=''),width=700, height=1200)
ggplot(df_plot)+ 
  geom_bar(aes(x = feature, y=mn, fill=color), stat="identity") + 
  geom_point(data = data_long, aes(x = feature, y = score), color = "black", size = 0.005, alpha = 0.2, position = position_jitter(width = 0.2)) +  # Overlay original data points
...
png(file=paste("plots/circuit_profile_bars_split2.png", sep=''),width=700, height=1200)
ggplot(df_plot)+ 
  geom_bar(aes(x = feature, y=mn, fill=color), stat="identity") + 
  geom_point(data = data_long, aes(x = feature, y = score), color = "black", size = 0.005, alpha = 0.2, position = position_jitter(width = 0.2)) +  # Overlay original data points
  facet_wrap(~clu_spl2, nrow = 3, scales='free') + 
...
comps_names_old=c('Ruminative_worry','Ruminative_brooding','Tension','Negative_bias','Threat_dysregulation','Anhedonia','Anxious_arousal','Cognitive_dyscontrol')
...
png(file=paste("plots/sym_pointplot.png", sep=''),width=1000, height=1000)
...
# Plot individual data points
png(file=paste("plots/beh_pointplot.png", sep=''),width=1000, height=1000)
ggplot(long_data, aes(x = Component, y = Value)) +
  geom_point(position = 'jitter', color = "grey", alpha=0.5) +
  facet_wrap(~clu, scales = "free_x") +  # add scales = "free_x" to allow each facet to have its own x scale + 
  geom_text(data=medians_all,aes(y=mdn_other),size=6,label="\u2014",family="Arial Unicode MS") +
...
# Plot individual data points
png(file=paste("plots/treat_pointplot.png", sep=''),width=1000, height=1000)
...
png(file=paste("plots/symps_corrmat.png", sep=''),width=400, height=800)
ggcorrplot(cmat, hc.order = F, type = "full", ggtheme = ggplot2::theme_minimal, show.diag = T)+
  scale_fill_gradient2(limit = c(-0.5,0.5), low = "blue", high =  "red", mid = "white", midpoint = 0) + labs(fill = "Spearman rho")+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
dev.off()
...
png(file=paste("plots/symps_corrmat_p.png", sep=''),width=400, height=800)
...
png(file=paste("plots/symps_corrmat_pfdr.png", sep=''),width=400, height=800)
ggcorrplot(cmat_adj, hc.order = F, type = "full", ggtheme = ggplot2::theme_minimal, show.diag = T)+
  scale_fill_gradient2(limit = c(-0.5,0.5), low = "blue", high =  "red", mid = "white", midpoint = 0) + labs(fill = "Spearman rho")+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
dev.off()
...
png(file=paste("plots/behs_corrmat.png", sep=''),width=400, height=800)
ggcorrplot(cmat, hc.order = F, type = "full", ggtheme = ggplot2::theme_minimal, show.diag = T)+
  scale_fill_gradient2(limit = c(-0.5,0.5), low = "blue", high =  "red", mid = "white", midpoint = 0) + labs(fill = "Spearman rho")+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
dev.off()
...
cmat_adj = cmat
cmat_adj[as.matrix(pmat) >= 0.05] = 0
png(file=paste("plots/behs_corrmat_p.png", sep=''),width=400, height=800)
ggcorrplot(cmat_adj, hc.order = F, type = "full", ggtheme = ggplot2::theme_minimal, show.diag = T)+
  scale_fill_gradient2(limit = c(-0.5,0.5), low = "blue", high =  "red", mid = "white", midpoint = 0) + labs(fill = "Spearman rho")+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
dev.off()
...
cmat_adj = cmat
cmat_adj[as.matrix(pmat_fdr) >= 0.05] = 0
png(file=paste("plots/behs_corrmat_pfdr.png", sep=''),width=400, height=800)
ggcorrplot(cmat_adj, hc.order = F, type = "full", ggtheme = ggplot2::theme_minimal, show.diag = T)+
  scale_fill_gradient2(limit = c(-0.5,0.5), low = "blue", high =  "red", mid = "white", midpoint = 0) + labs(fill = "Spearman rho")+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
dev.off()
...
comps=c('treat severity bl scaled', 'treat severity fu scaled', 'response', 'remission')
...
png(file=paste("plots/treat_corrmat.png", sep=''),width=400, height=800)
ggcorrplot(cmat, hc.order = F, type = "full", ggtheme = ggplot2::theme_minimal, show.diag = T)+
  scale_fill_gradient2(limit = c(-0.5,0.5), low = "blue", high =  "red", mid = "white", midpoint = 0) + labs(fill = "Spearman rho")+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
dev.off()
...
cmat_adj = cmat
cmat_adj[as.matrix(pmat) >= 0.05] = 0
png(file=paste("plots/treat_corrmat_p.png", sep=''),width=400, height=800)
ggcorrplot(cmat_adj, hc.order = F, type = "full", ggtheme = ggplot2::theme_minimal, show.diag = T)+
  scale_fill_gradient2(limit = c(-0.5,0.5), low = "blue", high =  "red", mid = "white", midpoint = 0) + labs(fill = "Spearman rho")+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
dev.off()
...
cmat_adj = cmat
cmat_adj[as.matrix(pmat_fdr) >= 0.05] = 0
png(file=paste("plots/treat_corrmat_pfdr.png", sep=''),width=400, height=800)
ggcorrplot(cmat_adj, hc.order = F, type = "full", ggtheme = ggplot2::theme_minimal, show.diag = T)+
  scale_fill_gradient2(limit = c(-0.5,0.5), low = "blue", high =  "red", mid = "white", midpoint = 0) + labs(fill = "Spearman rho")+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
dev.off()
...
png(file=paste("plots/rest_corrmat.png", sep=''),width=400, height=800)
ggcorrplot(cmat, hc.order = F, type = "full", ggtheme = ggplot2::theme_minimal, show.diag = T)+
  scale_fill_gradient2(limit = c(-0.5,0.5), low = "blue", high =  "red", mid = "white", midpoint = 0) + labs(fill = "Spearman rho")+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
dev.off()
...
cmat_adj = cmat
cmat_adj[as.matrix(pmat) >= 0.05] = 0
png(file=paste("plots/rest_corrmat_p.png", sep=''),width=400, height=800)
ggcorrplot(cmat_adj, hc.order = F, type = "full", ggtheme = ggplot2::theme_minimal, show.diag = T)+
  scale_fill_gradient2(limit = c(-0.5,0.5), low = "blue", high =  "red", mid = "white", midpoint = 0) + labs(fill = "Spearman rho")+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
dev.off()
...
cmat_adj = cmat
cmat_adj[as.matrix(pmat_fdr) >= 0.05] = 0
png(file=paste("plots/rest_corrmat_pfdr.png", sep=''),width=400, height=800)
ggcorrplot(cmat_adj, hc.order = F, type = "full", ggtheme = ggplot2::theme_minimal, show.diag = T)+
  scale_fill_gradient2(limit = c(-0.5,0.5), low = "blue", high =  "red", mid = "white", midpoint = 0) + labs(fill = "Spearman rho")+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
dev.off()
...
png(file=paste("plots/sleepsuicid_bars.png", sep=''),width=800, height=800)
