...
highest_sleep = apply(merged_qc[c("qids_01", "qids_02", "qids_03", "qids_04")], 1, max)
highest_weight = apply(merged_qc[c("qids_06", "qids_07", "qids_08", "qids_09")], 1, max)
highest_psychomotor = apply(merged_qc[c("qids_15", "qids_16")], 1, max)
merged_qc$qids_total_score = highest_sleep + highest_weight + highest_psychomotor +
  merged_qc$qids_05 + merged_qc$qids_10 + merged_qc$qids_11 +
  merged_qc$qids_12 + merged_qc$qids_13 + merged_qc$qids_14
