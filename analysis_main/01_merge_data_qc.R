...
fd=read.csv('data/fd_table.csv') # framewise displacement information
img=read.csv('data/circ_table_mo6wmcsf_denoised.csv') # activation and connectivity values
ques=read.csv('data/quest_rad_ispotd_fu_hcpdes_engage_clean.csv') # questionnaire data
beh=read.csv('data/beh_rad_ispotd_hcpdes_engage_clean_inwn.csv') # behavioral data
