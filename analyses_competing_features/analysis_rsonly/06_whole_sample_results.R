...
write.csv(symps_results, 'appeal/analyses_competing_features/analysis_rsonly/symps_results_all.csv', row.names = F)
...
# Export the results in one table
write.csv(beh_results, 'appeal/analyses_competing_features/analysis_rsonly/beh_results_all.csv', row.names = F)
