...
set.seed(123123)
data=read.csv('analyses_competing_features/analysis_rsonly/out/dataset_merged_qc_imputed_combat_clin_std_clu_sympbeh.csv')
...
write.csv(symps_results_merged, 'analyses_competing_features/analysis_rsonly/out/symps_results_sh_merged.csv', row.names = F)
...
write.csv(beh_results_merged, 'analyses_competing_features/analysis_rsonly/out/beh_results_sh_merged.csv', row.names = F)

#### Save data ####

write.csv(data, 'analyses_competing_features/analysis_rsonly/out/dataset_merged_qc_imputed_combat_clin_std_clu_sympbeh_spl.csv')
