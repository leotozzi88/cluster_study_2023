...
# Save data
write.csv(merged, 'appeal/analyses_competing_features/analysis_rsonly/dataset_merged.csv', row.names = FALSE)
...
# Save data
write.csv(merged_qc, 'appeal/analyses_competing_features/analysis_rsonly/dataset_merged_qc.csv', row.names = FALSE)
