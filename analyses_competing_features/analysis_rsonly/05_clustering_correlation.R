...
data=read.csv('appeal/analyses_competing_features/analysis_rsonly/dataset_merged_qc_imputed_combat_clin_std.csv')

#### Clustering ####
img_vars_names_final=c('D2D1', 'D1D3', 'D1D4', 'D2D4', 'D3D4', 'S1S3', 'S2S4', 'S1S2', 'A2A1', 'A3A1', 'A4A2', 'A5A3', 'A4A6', 'A5A7')
...
# Save data
write.csv(data, 'appeal/analyses_competing_features/analysis_rsonly/dataset_merged_qc_imputed_combat_clin_std_clu.csv', row.names = FALSE)
