...
data=read.csv('appeal/analyses_competing_features/analysis_tokuda/dataset_merged_qc_imputed_combat_clin_std.csv')
...
# Save data
write.csv(data, 'appeal/analyses_competing_features/analysis_tokuda/dataset_merged_qc_imputed_combat_clin_std_clu.csv', row.names = FALSE)
