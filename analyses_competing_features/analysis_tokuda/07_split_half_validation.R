...
data=read.csv('appeal/analyses_competing_features/analysis_tokuda/dataset_merged_qc_imputed_combat_clin_std_clu.csv')
...
png(file=paste("appeal/analyses_competing_features/analysis_tokuda/circuit_profile_splhalf.png", sep=''),width=800, height=800)
...
write.csv(symps_results_merged, 'appeal/analyses_competing_features/analysis_tokuda/symps_results_sh_merged.csv', row.names = F)
...
write.csv(beh_results_merged, 'appeal/analyses_competing_features/analysis_tokuda/beh_results_sh_merged.csv', row.names = F)

# Export
write.csv(data, 'appeal/analyses_competing_features/analysis_tokuda/dataset_merged_qc_imputed_combat_clin_std_clu_dataspl.csv', row.names = F)
