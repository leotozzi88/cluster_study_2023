...
write.csv(symps_results, 'appeal/analyses_competing_features/analysis_dmn/symps_results_all.csv', row.names = F)
...
# Export the results in one table
write.csv(beh_results, 'appeal/analyses_competing_features/analysis_dmn/beh_results_all.csv', row.names = F)
