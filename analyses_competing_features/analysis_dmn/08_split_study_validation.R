...
for (study in unique(data$study_reduced)){
  ...
  write.csv(symps_results_merged, paste('appeal/analyses_competing_features/analysis_dmn/symps_results_merged_ho_', study, '.csv', sep=''), row.names = F)
...
for (study in unique(data$study_reduced)){
  ...
  write.csv(beh_results_merged, paste('appeal/analyses_competing_features/analysis_dmn/beh_results_merged_ho_', study, '.csv', sep=''), row.names = F)
