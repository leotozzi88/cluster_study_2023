...
for (study in unique(data$study_reduced)){
  ...
  write.csv(symps_results_merged, paste('analyses_competing_features/analysis_dmn/out/symps_results_study_merged', study, '.csv', sep=''), row.names = F)
  ...
  write.csv(beh_results_merged, paste('analyses_competing_features/analysis_dmn/out/beh_results_study_merged', study, '.csv', sep=''), row.names = F)
