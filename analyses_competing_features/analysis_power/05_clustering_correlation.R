...
data=as.data.frame(vroom('appeal/analyses_competing_features/analysis_power/dataset_merged_qc_imputed_combat_all_std.csv'))
...
# Save data
write.csv(data, 'appeal/analyses_competing_features/analysis_power/dataset_merged_qc_imputed_combat_clin_std_clu.csv', row.names = FALSE)
