...
img=vroom('analyses_competing_features/analysis_power/out/powers_tab.csv')
...
# Save data
write.csv(merged, 'analyses_competing_features/analysis_power/out/dataset_merged.csv', row.names = FALSE)
...
# Save data
write.csv(merged_qc, 'analyses_competing_features/analysis_power/out/dataset_merged_qc.csv', row.names = FALSE)
