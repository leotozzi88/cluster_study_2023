...
write.csv(treat_results, 'appeal/analyses_competing_features/analysis_power/treat_results_all.csv', row.names = F)

# Export
write.csv(data, 'appeal/analyses_competing_features/analysis_power/dataset_merged_qc_imputed_combat_clin_std_clu_dataspl_treat.csv', row.names = FALSE)
