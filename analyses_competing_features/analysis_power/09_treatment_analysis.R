...
write.csv(treat_results, 'analyses_competing_features/analysis_power/out/treat_results_all.csv', row.names = F)
...
write.csv(data, 'analyses_competing_features/analysis_power/out/dataset_merged_qc_imputed_combat_clin_std_clu_sympbeh_spl_treat.csv')
