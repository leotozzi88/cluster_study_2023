...
png(file=paste("appeal/analyses_competing_features/analysis_power/circuit_profile_splhalf.png", sep=''),width=800, height=800)
...
write.csv(symps_results_merged, 'appeal/analyses_competing_features/analysis_power/symps_results_sh_merged.csv', row.names = F)
...
write.csv(beh_results_merged, 'appeal/analyses_competing_features/analysis_power/beh_results_sh_merged.csv', row.names = F)

# Export
write.csv(data, 'appeal/analyses_competing_features/analysis_power/dataset_merged_qc_imputed_combat_clin_std_clu_dataspl.csv', row.names = F)
